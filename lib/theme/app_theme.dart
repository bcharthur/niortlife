...
/// Implements Contemporary French Civic Mobile design with Niort Blue Clarity color theme.
class AppTheme {
  AppTheme._();

  // Niort Blue Clarity Color Palette
  static const Color primaryLight = Color(0xFF1E9BD6); // Niort Agglo brand blue
  static const Color primaryVariantLight =
      Color(0xFF0A7BB8); // Darker blue variant
  static const Color secondaryLight = Color(0xFF2ECC71); // Success green
  static const Color warningLight = Color(0xFFF39C12); // Warm orange
  ...
  static const Color borderLight = Color(0xFFE8ECEF); // Light gray
  ...
  // Dark theme variants (maintaining same color relationships)
  static const Color primaryDark = Color(0xFF1E9BD6);
  static const Color primaryVariantDark = Color(0xFF0A7BB8);
  static const Color secondaryDark = Color(0xFF2ECC71);
  ...
  /// Light theme implementing Contemporary French Civic Mobile design
  ...
  /// Dark theme implementing Contemporary French Civic Mobile design
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Headline styles - Inter SemiBold for headings
      ...
      // Body styles - Inter Regular for body text
      ...
      // Label styles - Inter Medium for labels
